...
var resizePizzas = function(size) {
   ...
   *   replaced with single call that is stored in variable 'randomPizzas'
   * - removed unnecessary function 'determineDX()' and replaced with straight
   *   percentages
   * - this allowed removal of code dependent on 'determineDX()' that was
